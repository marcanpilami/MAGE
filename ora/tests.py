...
def utility_create_test_envt(i):
    ...
    impl_4_1 = ComponentImplementationClass(name='Websphere AS cluster user app platform', description='Mutualized WAS cell', implements=l3, python_model_to_use=ContentType.objects.get_for_model(WasCell))
    impl_4_2 = ComponentImplementationClass(name='Glassfish AS instance user app platform', description='Glassfish. Dedicated.', implements=l3, python_model_to_use=ContentType.objects.get_for_model(GlassfishAS))
    impl_5_1 = ComponentImplementationClass(name='MQ Series integration app configuration', description='MQ Series. Mut.', implements=l3, python_model_to_use=ContentType.objects.get_for_model(MqQueueManagerParams))
    impl_6_1 = ComponentImplementationClass(name='MQ Series user web app configuration', description='MQ Series. Mut.', implements=l3, python_model_to_use=ContentType.objects.get_for_model(MqQueueManagerParams))
    impl_1_1.save()
    impl_1_2.save()
    impl_2_1.save()
    impl_3_1.save()
    ...
    us1 = UnixServer(name='server_dev')
    us1.save()
    us2 = UnixServer(name='tsts_oracle')
    us2.save()
    us3 = UnixServer(name='tsts_was')
    us3.save()
    us4= UnixServer(name='prd_oracle')
    us4.save()
    us5= UnixServer(name='prd_was_user')
    us5.save()
    us6= UnixServer(name='prd_was_integration')
    us6.save()
    ...
    wasCell1 = WasCell(name='wcDEV')
    wasCell1.save()
    wasCell1.dependsOn.add(us1)
    wasCell2 = WasCell(name='wcTST')
    wasCell2.save()
    wasCell2.dependsOn.add(us3)
    wasCell3 = WasCell(name='wcPRD')
    wasCell3.save()
