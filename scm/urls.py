...
urlpatterns = [
    url(r'envt/hist/(?P<project>\w+-?\w*)/(?P<envt_name>.+)/(?P<limit>\d+)', views.all_installs, name='envtinstallhistprm'),
    url(r'envt/hist/(?P<project>\w+-?\w*)/(?P<envt_name>.+)', views.all_installs, {'limit': 90}, name='envtinstallhist'),

    url(r'delivery/(?P<project>\w+-?\w*)$', views.delivery_list, name='deliveries'),
    url(r'delivery/(?P<project>\w+-?\w*)/(?P<iset_id>\d+)$', views.delivery, name='delivery_detail'),

    # Delivery hand-off forms
    url(r'delivery/edit/(?P<project>\w+-?\w*)$', views.delivery_edit, name='delivery_create'),
    ...
    url(r'version/summary/(?P<project>\w+-?\w*)$', views.lc_versions_per_environment, name='lc_installs_envts'),
    url(r'version/lc/(?P<project>\w+-?\w*)$', views.lc_list, name='lc_list'),
    ...
    url(r'tag/(?P<project>\w+-?\w*)$', views.tag_list, name='tag_list'),
    ...
    url(r'bck/(?P<project>\w+-?\w*)$', views.backup_list, name='backup_list'),
