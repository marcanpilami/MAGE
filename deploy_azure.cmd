...
:: 7. Handler.
IF EXIST "%DEPLOYMENT_SOURCE%\SiteExtensions\PythonFastCGI\ApplicationHost.xdt" (
	copy /B /Y "%DEPLOYMENT_SOURCE%\SiteExtensions\PythonFastCGI\ApplicationHost.xdt" "%DEPLOYMENT_TARGET%\..\ApplicationHost.xdt"
)
...
IF EXIST "%DEPLOYMENT_TARGET%\manage.py" (
  IF EXIST "%DEPLOYMENT_TARGET%\env\lib\site-packages\django" (
    IF NOT EXIST "%DEPLOYMENT_TARGET%\.skipDjango" (
      echo Applying Django DB Migrations. You can skip Django specific steps with a .skipDjango file.
