...
def utility_create_meta():
    ...
    impl4 = ImplementationDescription.create_or_update('oracleschema', 'schema on an Oracle instance', self_description_pattern='%name| on |%instance.sid', tag='oracle').\
            ...
            add_field_simple('password', 'login to use for DBA access', sensitive=True).\
            ...
            add_field_computed('jdbc', 'JDBC connection string', 'jdbc:oracle:thin:@//|%dns_to_use;instance.server.dns|:|%instance.port|/|%service_name_to_use;instance.sid', sensitive=True).\
    ...
    impl14 = ImplementationDescription.create_or_update('jbossgroup', u'groupe d\'AS JBoss', self_description_pattern='%name', tag='jboss').\
            add_field_simple('name', 'application name').\
            add_field_simple('profile', 'application name').\
            ...
            add_field_simple('max_heap_mb', 'x', 384).\
            add_field_simple('max_permgen_mb', 'x', 128).\
            add_field_simple('start_heap_mb', 'x', 256).\
