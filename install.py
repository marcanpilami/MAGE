...
parser.add_option("-e", "--envt", type="string", dest="envt", help=u"environnement sur lequel installer")
parser.add_option("-c", "--component", type="string", dest="components", action="append", help=u"composant à mettre à jour à l'aide du CTV désigné")
parser.add_option("-i", "--installset", type="string", dest="isid", help=u"nom du patch ou de la sauvegarde à installer")
parser.add_option("-t", "--test", action="store_true", dest="test", default=False, help=u"ne faire que les tests d'installabilité, pas le référencement")
parser.add_option("-v", "--verbose", action="store_true", dest="verbose", default=False, help=u"afficher des informations")
parser.add_option("-f", "--force", action="store_true", dest="force", default=False, help=u"forcer l'installation même si les prérequis en sont pas vérifiés")
